...
const Nav = () => {
  ...
  return (
    <div>
      ...
      <nav className={`bg-white shadow  p-4  transition-all duration-0.5s ease-in-out ${isScrolled ? 'fixed top-0 left-0 w-full z-50 bg-white/30 backdrop-blur-[50px]' : 'relative w-full'} xl:py-1`}>
        <div>
          <Image 
